...
<Page number={0}>
      ...
      <div className="page" ref={this.ref}>
              ...
              <div className="page-text">
              <p className="text-book-responsive">Il<span className="text-color">s</span> trouvère<span className="text-color">nt</span> le lou<span className="text-color">p</span> endormi au pie<span className="text-color">d</span> d'un arbre.</p>
